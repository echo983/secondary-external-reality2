...
export const propositions = [
  ...
  {height: 0, entities: ["door-1"], text: "door-1 现在是关着的，没有上锁。"},
  {height: 0, entities: ["bed-1", "bedroom"], text: "bed-1 在卧室里。"},
  {height: 0, entities: ["floor-1", "bedroom"], text: "floor-1 是卧室的地面。"},
  {height: 0, entities: ["blanket-1", "bed-1"], text: "blanket-1 现在放在 bed-1 上。"},
  {height: 0, entities: ["blanket-1"], text: "blanket-1 摸起来柔软，可以压缩。"},
  {height: 0, entities: ["kettle-1", "bedroom"], text: "kettle-1 在卧室里，插着电。"},
  {height: 0, entities: ["kettle-1"], text: "kettle-1 正在加热。"},
  {height: 0, entities: ["closet-1", "bedroom"], text: "closet-1 在卧室里，门是关着的。"},
  {height: 0, entities: ["rug-1", "bedroom"], text: "rug-1 卷着放在墙角。"},
  {height: 1, entities: ["blanket-1"], text: "blanket-1 的厚度约为三厘米。"},
  {height: 2, entities: ["door-1"], text: "door-1 门底缝隙宽约一厘米。"},
  {height: 3, entities: ["kettle-1"], text: "kettle-1 的水已经烧开，发出鸣笛声。"},
  {height: 4, entities: ["self", "kettle-1"], text: "self 把 kettle-1 关掉了。"},
  {height: 5, entities: ["kettle-1"], text: "kettle-1 不再加热，安静下来。"},
  {height: 6, entities: ["closet-1"], text: "closet-1 被打开了，露出里面挂着的衣服。"},
  {height: 7, entities: ["rug-1", "blanket-1"], text: "rug-1 摸起来比 blanket-1 粗糙，不太柔软。"},
  {height: 8, entities: ["self", "blanket-1", "door-1"], text: "self 把 blanket-1 从 bed-1 上拿起来，塞进了 door-1 门底的缝隙里。"},
  {height: 9, entities: ["blanket-1", "door-1"], text: "blanket-1 现在是压缩状态，塞在 door-1 门底缝隙里，不再放在 bed-1 上。"},
  {height: 10, entities: ["self", "closet-1"], text: "self 走到 closet-1 前面，看了看里面的衣服。"}
];
