...
- **GROUND 换 `qwen3-30b-a3b-fp8`**:准确率打平基线,延迟降了约 37%。**〔同日更正〕真人测试在"看看周围"这类模糊空间指代上抓到这个模型不稳定(重复调用有时对有时错),8 条测试案例没覆盖这一类输入。GROUND 已经换回基线模型,详见 `docs/ground-model-revert-findings-2026-08-29.md`。**
